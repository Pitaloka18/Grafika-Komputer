/*
   Buatlah project dengan membuat Transformasi pada object 3D (jika ada referensi cantumkan) 
      Nama     = Debby Cyntia Pitaloka, Feronika Liana, Rachael
      Tentang  = animasi pengejaran rabbit 1 dan 2 untuk menambah konsep pada abstrak background picture
      Sumber   = code (https://openprocessing.org/sketch/126780), picture (https://shorturl.at/diHI3)
*/
...
void setup() {
  size(700, 500);
  photo = loadImage("rabbit.png");
  photo.resize(450, 300); // Menyesuaikan ukuran gambar
}
...
void chara(int a, int b, boolean close) {
  ...
  strokeWeight(2);
  //ear_under
  stroke(255, 0, 0);    //untuk warna objek (code transformasi)
